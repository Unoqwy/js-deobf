...
export function fn_vars_unwrap(ctx: ReverseContext) {
    const $declarators = ctx.$tree("VariableDeclarationStatement > VariableDeclaration > VariableDeclarator[binding.type='BindingIdentifier'][init.type='FunctionExpression']");
